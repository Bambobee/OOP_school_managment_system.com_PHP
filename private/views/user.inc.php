...
<div class="card m-2 shadow-sm" style="max-width: 12rem;min-width: 14rem;">
    <img src="<?=$image?>" class="card-img-top rounded-circle w-75 d-block mx-auto mt-1" alt="Card image">
    <div class="card-body">
