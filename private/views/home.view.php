    ...
    <div class="row justify-content-center">
        ...
        <div class="col-3 card shadow rounded m-4 p-0 border">
            <a href="<?=ROOT?>/schools">
                ...
                <div class="card-header">View all schools</div>
            </a>
        </div>
        <?php endif; ?>
        ...
        <div class="col-3 card shadow rounded m-4 p-0 border">
            <a href="<?=ROOT?>/users">
                ...
                <div class="card-header">View all staff members</div>
            </a>
        </div>
        <?php endif; ?>
        ...
        <div class="col-3 card shadow rounded m-4 p-0 border">
            <a href="<?=ROOT?>/classes">
                ...
                <div class="card-header">View all classes</div>
            </a>
        </div>
        ...
        <div class="col-3 card shadow rounded m-4 p-0 border">
            <a href="<?=ROOT?>/statistics">
                ...
                <div class="card-header">View all statistics</div>
            </a>
        </div>
        ...
        <div class="col-3 card shadow rounded m-4 p-0 border">
            <a href="<?=ROOT?>/settings">
                ...
                <div class="card-header">View app settings</div>
            </a>
        </div>
        <?php endif; ?>
        ...
        <div class="col-3 card shadow rounded m-4 p-0 border">
            <a href="<?=ROOT?>/logout">
                ...
                <div class="card-header">Logout from the system</div>
            </a>
        </div>
