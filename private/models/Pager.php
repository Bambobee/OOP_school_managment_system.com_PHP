        ...
        <div>
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    <li class="page-item"><a href="<?=$this->links['first']?>" class="page-link">First</a></li>

                    <?php for($x = $this->start; $x <= $this->end; $x++):?>
                    <li class="page-item <?= ($x == $this->page_number) ? 'active' : ''; ?>"><a href="<?=preg_replace('/page=[0-9]+/', "page=".$x, $this->links['current_link'])?>" class="page-link"><?=$x; ?></a></li>
                    <?php endfor; ?>
                    <li class="page-item"><a href="<?=$this->links['next']?>" class="page-link">Next</a></li>
                </ul>
            </nav>
        </div>
<?php  }
